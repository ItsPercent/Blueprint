...
This modpack aims to fix this. Mods and addons are chosen carefully, and are usually heavily modified in order to better suit the modpacks goal. A complete list of all the major changes is below, but to keep it brief, if you dislike vertical item vaults, you're going to like this modpack.

## Showcase
Here is a wonderful video by Mysda that shows off all of the features added in the newest Create Mod update! ([Subscribe](https://www.youtube.com/@Mysda_) to them if you haven't already)
<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/tz5maMNgWqE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>

## Pack Features

- ⚙️Create Mod 6
- 🍒Cherry-Picked Create Addons
- 🍗Farmer's Delight
- 🏛️Dungeons and Taverns
- ☀️Built-in Shaders
- 🧭Axiom
- 🎒All new update content!
- 💻CC:Tweaked
- 🧩KubeJS (Custom Recipes!)
- Exactly **100** mods.

That list was kinda short, so if your looking for a complete list of everything Blueprint has to offer, here's all of the mods included: (Be warned, it's a tad long!)

<details>
<summary>Current Modlist</summary>
...
- [Copper Age Backport](https://modrinth.com/mod/a1llHwl4) by Smallinger
...
- [Create Diesel Generators](https://modrinth.com/mod/ZM3tt6p1) by George VI
- [Create Jetpack](https://modrinth.com/mod/UbFnAd4l) by possible\_triangle
- [Create: Access Denied](https://modrinth.com/mod/l7OfHLkp) by 5w14
- [Create: Central Kitchen](https://modrinth.com/mod/btq68HMO) by DragonsPlus
...
- [Create: Cyber Goggles](https://modrinth.com/mod/TlQAWQCY) by ForgeStove
- [Create: Dragons Plus](https://modrinth.com/mod/dzb1a5WV) by DragonsPlus
- [Create: Extra Gauges](https://modrinth.com/mod/6YJgomwt) by LiukRast, Francywott, swzo
- [Create: Ez Stock Ticker](https://modrinth.com/mod/qYDytzUC) by Cake
- [Create: Meta Logistics](https://modrinth.com/mod/2ACRRn3U) by xenonli \(xeli\)
- [Create: Mobile Packages](https://modrinth.com/mod/1vXRfEHZ) by Tim Heidler
...
- [Dark Mode Everywhere](https://modrinth.com/mod/k3lrwGqk) by Buuz135
- [Draggable Lists](https://modrinth.com/mod/aLcHfalx) by MrMelon54
- [Dynamic FPS](https://modrinth.com/mod/LQ3K71Q1) by juliand665 & LostLuma
- [EMI](https://modrinth.com/mod/fRiHVvU7) by Emi
- [Ender's Delight](https://modrinth.com/mod/2uEhdGKt) by Axedgaming, Furti Two
...
- [Item Obliterator](https://modrinth.com/mod/3ESR84kR) by ElocinDev, Recon1991, UQuark
...
- [Miners Delight](https://modrinth.com/mod/qMxbM4BQ) by Sammy;, Soytutta
...
- [Platform](https://modrinth.com/mod/i6fiqm5y) by ItsBlackGear
...
- [VanillaBackport](https://modrinth.com/mod/6xwxDTgf) by BlackGear
- [Vanillin](https://modrinth.com/mod/6qTrsXCy) by Jozufozu, PepperCode1
- [What Are They Up To](https://modrinth.com/mod/AtB5mHky) by Corosus
- [World Host](https://modrinth.com/mod/2AIZDfYo) by Gaming32
...
## Pack Changes
Although some powerful mods are in this pack, such as Create: Connected, they have been changed. Here are some of the most important changes that may catch you off guard-

<details>
<summary>Most of the Changes</summary>

- Firework rockets don't work with elytras.\
  This is mainly to encourage building trains, and not just use an elytra to get where your going.
- Computercraft recipes have been changed.\
  Helps to better integrate them with the create mod while also making them harder to obtain.
- Computercraft turtles have been nuked.\
  They're adorable, but too powerful. xD
- Items from Create: Dragons Plus have been removed\
  Liquid dyes are too powerful!
- Basically everything from Create: Connected\
  "Why keep it then?" Well it has some useful features, and jukeboxes on elevators are kinda funny. :P
- And finally...\
  No Copycat Slopes\
  They look goofy, ok?
...
## Server Installation
Blueprint can be installed on your minecraft server! Install the `mrpack-install` package on your server and add it to your `/usr/local/bin` directory. From there, navigate to where you want your server to be stored and run `mrpack-install bpcreate` to have the server version directly installed to your drive.

## Issue Reporting
Should you encounter any issues while playing, please let me know using the issues tab. I will get back to you as soon as I can!